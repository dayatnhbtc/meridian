...
const PAPER_POSITION_TOOLS = ["open_paper_position", "get_paper_position", "close_paper_position", "list_paper_positions"];
const MANAGER_TOOLS  = new Set(["close_position", "claim_fees", "swap_token", "get_position_pnl", "get_my_positions", "get_wallet_balance", ...PAPER_POSITION_TOOLS]);
const SCREENER_TOOLS = new Set(["deploy_position", "get_active_bin", "get_top_candidates", "check_smart_wallets_on_pool", "get_token_holders", "get_token_narrative", "get_token_info", "search_pools", "get_pool_memory", "get_wallet_balance", "get_my_positions", ...PAPER_POSITION_TOOLS]);
...
const INTENT_TOOLS = {
  ...
  deploy:      new Set(["deploy_position", "open_paper_position", "get_paper_position", "list_paper_positions", "get_top_candidates", "get_active_bin", "get_pool_memory", "check_smart_wallets_on_pool", "get_token_holders", "get_token_narrative", "get_token_info", "search_pools", "get_wallet_balance", "get_my_positions", "add_pool_note"]),
  close:       new Set(["close_position", "close_paper_position", "get_paper_position", "list_paper_positions", "get_my_positions", "get_position_pnl", "get_wallet_balance", "swap_token"]),
  ...
  positions:   new Set(["get_my_positions", "get_position_pnl", "get_wallet_balance", "set_position_note", "get_wallet_positions", "get_paper_position", "list_paper_positions"]),
